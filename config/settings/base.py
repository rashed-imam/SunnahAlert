...
# sunnah_alert/
APPS_DIR = ROOT_DIR / "sunnah_alert"
REACT_APP_DIR = ROOT_DIR / "frontend"
env = environ.Env()
...
LOCAL_APPS = [
    "sunnah_alert.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "sunnah_alert.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "DIRS": [str(APPS_DIR / "templates"), str(REACT_APP_DIR / "build"),],
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sunnah_alert.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""rashed imam""", "rashed162@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "sunnah_alert.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "sunnah_alert.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
